...
DROP TABLE IF EXISTS `dashboard_datasource_config`;
CREATE TABLE `dashboard_datasource_config` (
...
DROP TABLE IF EXISTS `dashboard_datasets_custom`;
CREATE TABLE `dashboard_datasets_custom` (
...
DROP TABLE IF EXISTS `dashboard_datasets_original`;
CREATE TABLE `dashboard_datasets_original` (
  `id` bigint(32) NOT NULL AUTO_INCREMENT COMMENT '数据集ID',
